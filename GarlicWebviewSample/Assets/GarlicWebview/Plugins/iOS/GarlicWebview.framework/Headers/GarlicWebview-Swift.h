...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GarlicWebview",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC13GarlicWebview11GarlicUtils")
@interface GarlicUtils : NSObject
+ (CGFloat)PointToPxWithPt:(CGFloat)pt SWIFT_WARN_UNUSED_RESULT;
+ (CGFloat)PxToPointWithPx:(CGFloat)px SWIFT_WARN_UNUSED_RESULT;
+ (CGFloat)GetScale SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP13GarlicWebview21GarlicWebviewProtocol_")
@protocol GarlicWebviewProtocol
